...
class KTaskReviewer(SecureReprMixin, SQLModel, table=True):
    __tablename__ = "k_task_reviewer"
    ...
    task: "KTask" = Relationship(
        back_populates="task_reviewers",
        sa_relationship_kwargs={"passive_deletes": True},
    )
    principal: "KPrincipal" = Relationship(
        back_populates="task_reviewer_assignments",
        sa_relationship_kwargs={"passive_deletes": True},
    )


__all__ = ["KTaskReviewer"]
